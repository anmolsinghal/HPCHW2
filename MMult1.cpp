...
void MMult1(long m, long n, long p, double *a, double *b, double *c) 
{
...
int main(int argc, char** argv) {
  ...
  for (long p = PFIRST; p < PLAST; p += PINC) {
    ...
    double bandwidth = sizeof(double)*NREPEATS*(m*k*n)*4/1e9/time; // TODO: calculate from m, n, k, NREPEATS, time
